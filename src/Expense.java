public class Expense {
  ...
  /**
   * the method takes a sep character as a parameter and returns a formatted string representing the
   * object's data in CSV (Comma-Separated Values) format.
  ...
  public static Expense parseFromCsv(String line, char sep) {
    ...
    String amountStr = line.substring(sepIndex + 1);
